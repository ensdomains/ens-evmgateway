...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if(!L2_REVERSE_RESOLVER_ADDRESS) throw ('Set $L2_REVERSE_RESOLVER_ADDRESS')
  console.log({VERIFIER_ADDRESS, L2_REVERSE_RESOLVER_ADDRESS, DEFAULT_REVERSE_RESOLVER_ADDRESS})
  await deploy(`${CHAIN_NAME}L1ReverseResolver`, {
    from: deployer,
    contract:'L1ReverseResolver',
    args: [VERIFIER_ADDRESS, L2_REVERSE_RESOLVER_ADDRESS, DEFAULT_REVERSE_RESOLVER_ADDRESS],
    log: true,
  });
};
export default func;
