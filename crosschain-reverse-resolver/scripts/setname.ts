...
export const main = async () => {
  ...
  if (!process.env.L2_REVERSE_RESOLVER_ADDRESS)
    throw 'Set L2_REVERSE_RESOLVER_ADDRESS';
  ...
  const L2ReverseResolver = L2ReverseResolverFactory
                                .connect(signer)
                                .attach(L2_REVERSE_RESOLVER_ADDRESS);

  console.log({ L2_REVERSE_RESOLVER_ADDRESS, L2_PROVIDER_URL,ENS_NAME, ETH_ADDRESS, namespace, name, reversenode})
